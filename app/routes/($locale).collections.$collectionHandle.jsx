...
/** @typedef {Record<string, string | boolean>} VariantFilterParam */
/** @typedef {Record<'price', {max?: number; min?: number}>} PriceFiltersQueryParam */
/**
 * @typedef {Record<
 *   'variantOption',
...
/** @typedef {import('~/components/SortFilter').AppliedFilter} AppliedFilter */
